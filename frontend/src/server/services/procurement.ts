...
export const MARKETPLACE: ProviderV2[] = [
  { name: "Midjourney Proxy Engine", category: "Image", tier: "Premium", cost: 1.00, quality: 99, speed: 40, reliabilityScore: 95, endpoint: `${config.baseUrl}/test-402-provider?cost=1.00` },
  { name: "FLUX.1 Ultra (8K)", category: "Image", tier: "Premium", cost: 0.50, quality: 95, speed: 70, reliabilityScore: 98, endpoint: `${config.baseUrl}/test-402-provider?cost=0.50` },
  { name: "SDXL Turbo", category: "Image", tier: "Budget", cost: 0.05, quality: 75, speed: 99, reliabilityScore: 90, endpoint: `${config.baseUrl}/test-402-provider?cost=0.05` },
  { name: "HuggingFace FLUX Schnell", category: "Image", tier: "Budget", cost: 0.01, quality: 80, speed: 85, reliabilityScore: 85, endpoint: `${config.baseUrl}/test-402-provider?cost=0.01` }
];
