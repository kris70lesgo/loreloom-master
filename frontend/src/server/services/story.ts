import { z } from "zod";
import { AiBlockedError, ProviderRequestError } from "@/server/ai/errors";
import { generateStructured } from "@/server/ai/providers";
import type { StructuredGenerateOutput, ToolDefinition } from "@/server/ai/types";
